...
<body>
    <nav>
        <h1><a href="divisiones.php">Registro de archivos de División de Estudios</a></h1>
    ...
    <table>
        ...
        <tbody>
            <?php
                ...
                $logFilePath = './scripts/logs/division_de_estudios/eventos_división_de_estudios_' . $selectedDate . '.log';
